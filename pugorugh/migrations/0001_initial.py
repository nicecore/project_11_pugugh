# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2018-03-06 18:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(choices=[('s', 'Small'), ('m', 'Medium'), ('l', 'Large'), ('xl', 'Extra Large'), ('u', 'Unknown')], default='u', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='UserDog',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('age', models.CharField(choices=[('b', 'Baby'), ('y', 'Young'), ('a', 'Adult'), ('s', 'Senior')], max_length=10)),
                ('gender', models.CharField(choices=[('m', 'Male'), ('f', 'Female'), ('u', 'Unknown')], default='u', max_length=1)),
